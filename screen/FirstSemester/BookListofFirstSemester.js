...
const BookListofFirstSemester = ({navigation}) => {
  return (
    <ImageBackground
      ...
      <View
        ...
        />
        <Button2
          title={'ENG-321   Funtional English 3(3-0)'}
          onPress={() => navigation.navigate('PDF3')}
        />
        <Button2
          title={'ISL-321   Calculus & Analytical Geometry 2(2-0)'}
          onPress={() => navigation.navigate('PDF4')}
        />
        <Button2
          title={'MTH-323   Islamic Studies 3(3-0)'}
          onPress={() => navigation.navigate('PDF5')}
        />
      </View>
    </ImageBackground>
  );
...
export default BookListofFirstSemester;
